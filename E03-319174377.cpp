...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelBase = glm::translate(modelBase, glm::vec3(0.0f, -1.895f, -5.0f));
		//otras transformaciones para el objeto
		modelBase = glm::scale(modelBase, glm::vec3(5.0f,6.0f,1.0f));
		...
		//para el techo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 2.35, -5.0f));
		model = glm::scale(model, glm::vec3(5.5f, 2.5f, 1.0f));
		...
		//para las ventanas del frente 1, ventana izq
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(-0.2f, 0.25f, 0.5f));
		...
		//para las ventanas del frente 2, ventana derecha
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.2f, 0.25f, 0.5f));
		model = glm::scale(model, glm::vec3(0.3f, 0.25f, 0.05f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para la puerta del frente
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.0f, -0.33f, 0.5f));
		model = glm::scale(model, glm::vec3(0.3f, 0.35f, 0.05f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//para el tronco de la izq
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(-0.75f, -0.38f, -0.15f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.478f, 0.255f, 0.067f);//color
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();//*/
		
		//para el tronco de la derecha
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.75f, -0.38f, -0.15f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//para las hojas del pino izq
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(-0.75f, -0.01f, -0.15f));
		model = glm::scale(model, glm::vec3(0.30f, 0.5f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 0.5f, 0.0f);//color
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[4]->RenderMeshGeometry();//*/

		//para las hojas del pino dere
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.75f, -0.01f, -0.15f));
		model = glm::scale(model, glm::vec3(0.30f, 0.5f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//para las ventanas del lado izq 1, ventana izq
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(-0.478f, 0.25f, -0.37f));
		model = glm::scale(model, glm::vec3(0.05f, 0.225f, 0.220f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//para las ventanas del lado izq 2, ventana der
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(-0.478f, 0.25f, 0.199f));
		model = glm::scale(model, glm::vec3(0.05f, 0.225f, 0.35f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//para las ventanas del lado der 1, ventana izq
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.478f, 0.25f, -0.37f));
		model = glm::scale(model, glm::vec3(0.05f, 0.225f, 0.220f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para las ventanas del lado der 2, ventana der
		model = modelBase;//modelo hijo del cubo rojo
		model = glm::translate(model, glm::vec3(0.478f, 0.25f, 0.199f));
		model = glm::scale(model, glm::vec3(0.05f, 0.225f, 0.35f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para dibujar la esfera, parte trasera de la casa
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, 0.0, -0.48f));
		...
		//para el piso
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -4.95f, -6.0f));
		model = glm::scale(model, glm::vec3(9.9f, 0.1f, 7.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.13f, 0.65f, 0.0f);//color
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();//*/
