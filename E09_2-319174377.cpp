...
bool bandera = 0;//para activar/desactivar la textura
bool banderaA = 0;//para activar/dedsactivar el giro de la esgera
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f + animacionX, 2.0f + animacionY, 2.0f + animacionZ));
		glUniform2fv(uniformTextureOffset, 1, glm::value_ptr(toffset));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//para el fuego de 180º
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(9.2f, -0.2f, 1.6f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::mat4(1.0);
		//10.0f, -0.2f, 2.3f
		model = glm::translate(model, glm::vec3(10.0f, -0.2f, 2.3f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para el fuego de 270º
		model = glm::mat4(1.0);
		//10.0f, -0.2f, 2.3f
		model = glm::translate(model, glm::vec3(9.9f, -0.2f, 0.7f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para el fuego de 45º
		/*model = glm::mat4(1.0);
		//10.4f, -0.2f, 1.9f
		model = glm::translate(model, glm::vec3(10.4f, -0.2f, 1.9f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para el fuego de 135º
		/*model = glm::mat4(1.0);
		//9.6f, -0.2f, 2.7f
		model = glm::translate(model, glm::vec3(9.7f, -0.2f, 2.1f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para el fuego de 225º
		/*model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(8.8f, -0.2f, 3.5f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//para el fuego de 315º
		/*model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(8.0f, -0.2f, 4.3f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
