...
int main()
{
 ...
 //Llamada a las funciones creadas antes del main
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		//obtenemos el tiempo y lo convertimos en valores enteros
		int segundos = (int)glfwGetTime();

		//el operador modulo para hacer ciclos de tres valores posibles, 0 1 2
		int fase = segundos % 3;

		//los colores que muestra en cada caso
		if (fase == 0) {
			//rojo
			var1 = 1.0f; var2 = 0.0f; var3 = 0.0f;
		}
		else if (fase == 1) {
			//verde
			var1 = 0.0f; var2 = 1.0f; var3 = 0.0f;
		}
		else {
			//azul
			var1 = 0.0f; var2 = 0.0f; var3 = 1.0f;
		}
		...
		glDrawArrays(GL_TRIANGLES,0,18);//3 un tringulo, 6 dos tringulos, 9 3 triangulos, etc
		glBindVertexArray(0);
