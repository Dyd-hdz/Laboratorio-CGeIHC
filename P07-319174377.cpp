...
int main()
{
	...
	//Declaración de segunda luz puntual, para la lampara
	...
	//luz fija para el carro
	spotLights[2] = SpotLight(0.0f, 0.0f, 1.0f,  // color azul
    1.0f, 1.0f,                       
    0.0f, 0.0f, 0.0f,  // posicion temporal, ya que se configurara a la parte de la parrilla
    1.0f, 0.0f, 0.0f,  // direccion hacia x psitivo ya que el carro ve hacia esa direccion
    1.0f, 0.0f, 0.0f,  
    30.0f);                            
	spotLightCount++;//*/

	//luz fija para el helicoptero
	spotLights[3] = SpotLight(1.0f, 1.0f, 0.0f,  // color amarilla
		1.0f, 1.0f,
		0.0f, 0.0f, 0.0f,  // posicion temporal, ya que se configurara a la parte de la parrilla
		0.0f, -1.0f, 0.0f,  // direccion hacia y negativo ya que su luz va hacia abajo del helicoptero
		1.0f, 0.0f, 0.0f,
		30.0f);
	spotLightCount++;//*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// para la luz del carro, enfrente
		glm::vec3 posLuzCarro = glm::vec3(7.4f + mainWindow.getmuevex(), 0.17f, -0.453f); 
		// la posicion de la parrilla, desde el origen, sin tomar encuenta las traslacion del modelo 
		// padre
		glm::vec3 dirLuzCarro = glm::vec3(1.0f, 0.0f, 0.0f); // direccion hacia donde avanza el carro
		spotLights[2].SetFlash(posLuzCarro, dirLuzCarro);

		// para la luz del helicoptero, hacia abajo
		glm::vec3 posLuzHel = glm::vec3(0.0f + mainWindow.getmuevexE(), 5.0f, 6.0);// la posicion del helicoptero
		glm::vec3 dirLuzHel = glm::vec3(0.0f, -1.0f, 0.0f); // direccion hacia abajo del helicoptero
		spotLights[3].SetFlash(posLuzHel, dirLuzHel);//*/
