...
Window::Window(GLint windowWidth, GLint windowHeight)
{
	...
	articulacion5 = 0.0f;
	articulacion6 = 0.0f;
	articulacion7 = 0.0f;//nueva articulacion, para llanta 3
	articulacion8 = 0.0f;//nueva articulacion, para llanta 4
	articulacion9 = 0.0f;//nueva articulacion, cola parte 1
	articulacion10 = 0.0f;//nueva articulacion, cola parte 2
...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_U)//nueva articulacion, para llanta 3
	{
		theWindow->articulacion7 += 10.0;
	}
	if (key == GLFW_KEY_I)//nueva articulacion, para llanta 4
	{
		theWindow->articulacion8 += 10.0;
	}
	if (key == GLFW_KEY_O)//nueva articulacion, para cola parte 1
	{
		theWindow->articulacion9 += 10.0;
	}
	if (key == GLFW_KEY_P)//nueva articulacion, para cola parte 2
	{
