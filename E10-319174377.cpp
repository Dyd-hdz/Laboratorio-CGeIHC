...
int i_curr_steps = 22;//el numero de frames
...
int main()
{
	...
	printf("3.-Presiona L para guardar frame\n4.-Presiona P para habilitar guardar nuevo frame\n5.-Presiona 1 para mover en -X y +Y\n6.-Presiona 2 para habilitar mover en -X y +Y\n");
	printf("7.-Presiona 3 para mover en -X y -Y\n8.-Presiona 4 para habilitar mover en -X y -Y\n9.-Presiona 5 para rotar 180 la nave en Y\n10.-Presiona 6 para habilitar la rotacion de 180º en Y\n");
	printf("11.-Presiona 7 para mover en +X y -Y\n12.-Presiona 8 para habilitar mover en +X y -Y\n13.-Presiona 9 para mover en +X y +Y\n14.-Presiona M para habilitar mover en +X y +Y");
...
void inputKeyframes(bool* keys)
{
	...
	//La tecla 1 va ser para restar 1 en X y sumar 2 en Y, es decir ⬉
	if (keys[GLFW_KEY_1])
	{
		if (ciclo < 1)
		{
			...
			movAvion_y += 2.0f;
			//giroAvion = 180;
			printf("\nmovAvion_x es: %f\tmovAvion_y es: %f\n", movAvion_x, movAvion_y);
			ciclo++;
			ciclo2 = 0;
	...
	//La tecla 3 va ser para restar 1 en X y restar 2 en Y, es decir ⬋
	if (keys[GLFW_KEY_3])
	{
		if (ciclo3 < 1)
		{
	...
	if (keys[GLFW_KEY_4])//Para que se pueda resetear el movimiento del ciclo 3
	{
		if (ciclo4 < 1)
		{
			ciclo3 = 0;
			ciclo4++;//para que entre una sola vez a la estructura, si no entraria en cada ciclo de reloj
			printf("Ya puedes modificar tu variable presionando la tecla 3\n");
		}
	}

	//La tecla 5 va ser para rotar 180º sobre Y ⟳
	if (keys[GLFW_KEY_5])
	{
		if (ciclo5 < 1)
		{
	...
	if (keys[GLFW_KEY_6])//Para que se pueda resetear la rotacion del ciclo 5
	{
		if (ciclo6 < 1)
		{
			ciclo5 = 0;
			ciclo6++;//para que entre una sola vez a la estructura, si no entraria en cada ciclo de reloj
			printf("Ya puedes modificar tu variable presionando la tecla 5\n");
		}
	}

	//La tecla 7 va ser para sumar 1 en X y restar 2 en Y, es decir ⬊
	if (keys[GLFW_KEY_7])
	{
		if (ciclo7 < 1)
		{
			...
			ciclo7++;
			ciclo8 = 0;
			printf("Presiona la tecla 8 para poder habilitar la variable\n");
		}

	}
	if (keys[GLFW_KEY_8])//Para que se pueda resetear el movimiento del ciclo 7
	{
		if (ciclo8 < 1)
		{
			ciclo7 = 0;
			ciclo8++;//para que entre una sola vez a la estructura, si no entraria en cada ciclo de reloj
			printf("Ya puedes modificar tu variable presionando la tecla 7\n");
		}
	}

	//La tecla 9 va ser para sumar 1 en X y sumar 2 en Y, es decir ⬈
	if (keys[GLFW_KEY_9])
	{
		if (ciclo9 < 1)
		{
			...
			ciclo9++;
			ciclo10 = 0;
			printf("Presiona la tecla M para poder habilitar la variable\n");
		}

	}
	if (keys[GLFW_KEY_M])//Para que se pueda resetear el movimiento del ciclo 9
	{
		if (ciclo10 < 1)
		{
			ciclo9 = 0;
			ciclo10++;//para que entre una sola vez a la estructura, si no entraria en cada ciclo de reloj
			printf("Ya puedes modificar tu variable presionando la tecla 9\n");
		}
	}
