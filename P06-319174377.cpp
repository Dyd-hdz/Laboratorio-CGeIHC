...
void CrearOctaedro()
{
	...
	GLfloat octaedro_vertices[] = {
		...
		0.0f,  0.5f,  0.0f,		0.67f,	0.79f,		0.0f,	0.0f,	-1.0f, //5
		...
		0.0f,  0.5f,  0.0f,		0.66f,	0.8f,		0.0f,	0.0f,	-1.0f, //11
		...
		0.0f,  -0.5f,  0.0f,	0.34f,	0.2f,		0.0f,	0.0f,	-1.0f, //17
		...
		0.0f,  -0.5f,  0.0f,	0.33f,	0.2f,		0.0f,	0.0f,	-1.0f, //23
	};
...
int main()
{
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/dado_animal_chanchito_vaca_volteado.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		//Instancia del coche 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmuevex() , -1.25f, -3.0f));
		modelaux = model;
		...
		//Llanta parabrisas
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.95f, 0.56f, -0.055f));
		//model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Llanta cajuela
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.4f, 0.0f, 0.047f));
		//model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
